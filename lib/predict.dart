...
predict(ImagePackage.Image image,
    [int? interpreterAddress]) async //Predicts the image using the pretrained model
{
  print('predict()');
  var interpreter;
  if (interpreterAddress == null) {
    ...
    interpreter = tfl.Interpreter.fromAddress(interpreterAddress);
  }
